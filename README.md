...
Overview
This project demonstrates an AI-assisted API automation testing framework developed using Playwright and Generative AI ( Playwright MCP ) capabilities.
...
Tests folder
Also we can add folder structure as below Structure for API tests:
